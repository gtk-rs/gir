...
//
//
// use codegen::subclass::class_impls;
//
//
...
//
//     class_impls::generate_impl(w, env, analysis, &subclass_info);
//
//     class_impls::generate_impl_ext(w, env, analysis, &subclass_info);
//
//     generate_any_impl(w, env, analysis, &subclass_info);
//
//
//     class_impls::generate_base(w, env, analysis, &subclass_info);
//
//
//     Ok(())
// }
